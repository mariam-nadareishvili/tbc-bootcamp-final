...
import com.tbc.bookli.core.ui.components.BookliLottie
...
fun SearchScreen(
    ...
    Column(
        ...
        if (state.searchBook.isEmpty()) {
            Spacer(Modifier.height(32.dp))

            BookliLottie(modifier = Modifier.fillMaxSize(), animationResId = R.raw.search)
        } else {
